...
import com.hypherionmc.sdlink.core.config.GameRuleBoolean;
...
public class GameRuleMessageConfig implements IChannelContainer {

    private transient final MessageType type;

    @Path("enabled")
    @SpecComment("Should these messages be posted. Valid values are ALWAYS, NEVER or GAMERULE")
    public GameRuleBoolean enabled = GameRuleBoolean.ALWAYS;
    ...
    public GameRuleMessageConfig(MessageType type, String format) {
        this.type = type;
        this.format = format;
    }
