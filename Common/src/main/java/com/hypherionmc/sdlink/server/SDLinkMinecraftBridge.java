...
public class SDLinkMinecraftBridge implements IMinecraftHelper {
    ...
    public void discordMessageReceived(Member member, String s1) {
        ...
        while (matcher.find()) {
            ...
            component.append(new TextComponent(prefix.substring(lastAppendPosition, matcher.start())).withStyle(baseStyle));
        ...
        component.append(new TextComponent(prefix.substring(lastAppendPosition)).withStyle(baseStyle));
