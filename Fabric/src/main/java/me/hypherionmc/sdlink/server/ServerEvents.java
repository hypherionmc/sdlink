...
import me.hypherionmc.sdlink.FabricLogReader;
import me.hypherionmc.sdlink.SDLinkConstants;
import me.hypherionmc.sdlink.platform.services.FabricPlatformHelper;
...
public class ServerEvents implements IMinecraftHelper {
    ...
    public void onServerStarted() {
        ...
        if (modConfig.messageConfig.sendConsoleMessages) {
            FabricLogReader.init(botEngine, FabricLoader.getInstance().isDevelopmentEnvironment());
        }
    }
    ...
    public void executeMcCommand(String s, String s1) {
        ...
        FabricPlatformHelper.executeCommand(server, command);
    }
